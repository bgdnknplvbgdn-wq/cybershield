...
const laws: LawArticle[] = [
  ...
  },
  {
    ...
    category: "cyber",
    summary:
      "Статьи 212, 249, 349-355 УК РБ: несанкционированный доступ, создание и распространение malware, кибермошенничество.",
    lawNumber: "УК РБ, гл. 26",
  },
  {
    id: "4",
    ...
    <div className="px-4 md:px-8 py-6 md:py-8 max-w-3xl mx-auto">
      ...
      <div className="mt-8 text-center">
        <div className="flex items-center justify-center gap-2 text-muted text-sm">
          <BookOpen size={16} />
          <span>Информация актуальна на 2024 год</span>
        </div>
