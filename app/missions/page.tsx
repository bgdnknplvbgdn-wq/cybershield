            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div
                    className={`w-12 h-12 rounded-lg flex items-center justify-center text-lg shrink-0 font-cyber font-bold border transition-all ${completed ? "bg-success/10 border-success/30 text-success neon-glow-success" : ""}`}
